...
def amo_L_question():
    message = (
        "<b>I see you're asking about what L means?</b>\n\n"
        ...
        "See the vendor spreadsheet for latest contact info for vendors: "
        "<a href='https://t.me/c/2410577414/3/51651'>Vendor Spreadsheet 🛒</a>\n\n"
...
Thinking about ordering from QSC as a first-time buyer? TLDR: Please Don't.
...
def safety():
    ...
    links = [ 
        ...
        "Always check your reconstituted peptide's pH level before injecting! 🧪📈 Tirzepatide should fall in the 6-9 pH range. (For subQ injections, 4-11 pH is generally considered 'safe'.) Find any pH 0-14 strips on Amazon.",
    ]
